...
<body>
    ...
    <div class="container">
        ...
        <div class="topo-3"><img src="../imagens/icon aluna.png" id="img-3"></div>
    </div>
            ...
            <div class="carousel-slide">
                ...
                <div class="carousel-item">
                    ...
                    <div class="image-center" id="item-2">
                        ...
                        <img src="../imagens/icon curtir.png" class="img-large-2">
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="image-title">
                    ...
                    <div class="image-center" id="item-3">
                        ...
                        <img src="../imagens/icon curtir.png" class="img-large-3">
                    </div>
                </div>
            </div>
        </div>
